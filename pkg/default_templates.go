...
const logTemplate = `{{ if .FormattedCurrentTime }}created: {{.FormattedCurrentTime}}{{ end }}{{ if .Tags }}
tags: {{.Tags}}{{ end }}
...
const tdTemplate = `{{ if .FormattedCurrentTime }}created: {{.FormattedCurrentTime}}{{ end }}{{ if .Tags }}
tags: {{.Tags}}{{ end }}
